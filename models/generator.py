...
from tensorflow.keras.layers import (
    Input, Conv2D, BatchNormalization, ReLU, Add, UpSampling2D, Concatenate, GlobalAveragePooling2D, Dense, Reshape, Multiply
)
...
def modified_residual_block(x, filters):
    """
    Custom residual block with 1x1 and 3x3 convolutions and Squeeze & Excitation.
    ...
    return squeeze_excitation_block(x)
