...
def load_data_from_txt(txt_file, img_size, normalize=True):
    ...
    with open(txt_file, 'r') as f:
        ...
        for line in lines:
            img_name = line.strip()
            img_path = os.path.join('Kvasir-SEG', 'images', img_name )
            mask_path = os.path.join('Kvasir-SEG', 'masks', img_name )
...
if __name__ == "__main__":
    ...
    # Load training data
    train_images, train_masks = load_data_from_txt('Kvasir-SEG/train.txt', img_size, normalize=True)
    ...
    np.save('Kvasir-SEG/train_images.npy', train_images)
    np.save('Kvasir-SEG/train_masks.npy', train_masks)

    # Load validation data with normalization
    val_images, val_masks = load_data_from_txt('Kvasir-SEG/test.txt', img_size, normalize=True)
    
    np.save('Kvasir-SEG/test_images.npy', val_images)
    np.save('Kvasir-SEG/test_masks.npy', val_masks)
